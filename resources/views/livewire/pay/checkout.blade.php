    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div class="px-4 pt-8">
            ...
            <form wire:submit.prevent="save()" class="mt-5 grid gap-6">
                ...
                @endif
                    <div class="relative">
                        <input wire:model.live="form.type_payment" checked value="p" class="peer hidden" id="radio_3" type="radio" name="radio">
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0 rounded-lg text-black">
            ...
            <div class="">
                <div class="flex flex-col sm:flex-row mb-3 mt-3">
                    <div class="w-1/2 mr-3">

                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Nome</label>
                        <input wire:model.blur="form.first_name" @props(['form.first_name']) type="text" id="text" class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" required>
                        @error('form.first_name') <span class="error text-sm mt-1 text-red-600">Digite um nome válido com mais de 3 caracteres</span> @enderror
                    </div>
                    <div class="w-1/2 mr-3">
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900">Sobrenome</label>
                        <input wire:model.blur="form.last_name" @props(['form.last_name'])    type="text"
                        class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm
                        shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" required>
                        @error('form.last_name') <span class="error text-sm mt-1 text-red-600">Digite um sobrenome válido com mais de 3 caracteres</span> @enderror
                    </div>
                </div>
                <div class="flex flex-col sm:flex-row mb-3 mt-3">
                    <div class="w-1/2 mr-3">
                        <label for="phonenumber" class="block mb-2 text-sm font-medium text-gray-900">Celular</label>
                        <input wire:model="form.phone_number" type="text" id="phonenumber"
                               class="w-full rounded-md border border-gray-200 px-4
                               py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500
                               focus:ring-blue-500 celphone" required>
                    </div>
                    <div class="w-1/2 mr-3">
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900">E-mail</label>
                        <input wire:model.live="form.email" type="text" class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row mb-3">
                    <div class="w-1/2 mr-3">
                        ...
                        <input wire:model.live="form.address_zip_code"
                               wire:keyup.prevent="updateCep" value="{{ $form->address_zip_code }}"
                               type="text"
                               placeholder="00000-000" id="text"
                               class="cep w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm
                    ...
                    <div class="w-3/4 mr-3">
                        ...
                        <input wire:model.live="form.address" type="text"
                               value="{{ $form->address }}"
                               placeholder="Ex: Av. Paulista"
                               class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm
                               outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row">
                    ...
                    <div class="w-full lg:w-2/4 mb-2 mr-3">
                        ...
                        <input wire:model="form.address_neighborhood"
                    ...
                    <div class="w-full lg:w-2/4 mb-2 mr-3">
                        ...
                        <input wire:model="form.address_city"
